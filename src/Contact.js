...
function Contact() {
  return (
    ...
    <Box textAlign="center" sx={{ pb: 1 }}>
      ...
      <Typography variant="h5" sx={{ mb: 5 }}>Feel free to reach out for collaborations or just a friendly hello.</Typography>
        ...
        <Grid item xs={12} md={7}>
          <Box component="form">
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField fullWidth label="Message" variant="outlined" multiline rows={4} size="small" />
              </Grid>
            </Grid>
            <Button 
              variant="contained" 
              sx={{ mt: 3, backgroundColor: "#dd6b7b", color: "white", borderRadius: "50px", padding: "10px 30px", display: "block",fontSize: "24px", mx: "auto" }}
            >
              Send Message
            </Button>
          </Box>
