...
const projects = [
  {
    ...
    details: [
      ...
      "Built human-in-the-loop coordination logic that requests user input only when necessary and aggregates results into a final solution.",
    ],
    tech: [
      "Python",
      "Multi-Agent Systems",
  ...
  },
  {
    ...
    tech: ["Docker Compose", "Python", "Airflow", "Prometheus", "Dashboard"],
